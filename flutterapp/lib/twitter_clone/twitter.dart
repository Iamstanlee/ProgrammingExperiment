...
void main() {
  runApp(CustomTheme(child: MyApp()));
}
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        SizedBox(width: 5),
                        Opacity(
                            opacity: 0.6, child: Text('@${twt.user.username}')),
                        SizedBox(width: 5),
                        Padding(
                        ...
                        SizedBox(width: 5),
                        Opacity(
                            opacity: 0.6, child: Text(timeAgo(twt.timestamp))),
                      ],
                    ),
                    SizedBox(height: 4),
                    Text(twt.twt),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        Text('${geekmz.following}',
                            style: TextStyle(fontWeight: FontWeight.w600)),
                        SizedBox(width: 2),
                        Opacity(opacity: 0.6, child: Text('Following')),
                        SizedBox(width: 15),
                        Text('${geekmz.followers}',
                            style: TextStyle(fontWeight: FontWeight.w600)),
                        SizedBox(width: 2),
              ...
              children: [
                Container(
                  ...
                  .followedBy(widget.list
                      .where(
                          (item) => item.user.username == widget.user.username)
                      .toList()
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Opacity(
                              opacity: 0.6,
                              child:
                                  Text(HomeScreenState.timeAgo(twt.timestamp))),
                        ],
                      ),
                      SizedBox(height: 4),
                      Text(twt.twt),
...
class Themes {
  static final ThemeData lightTheme = ThemeData(
    ...
    textTheme: TextTheme(
        headline: TextStyle(color: Colors.grey[850]),
        subtitle: TextStyle(color: Colors.grey[850])),
...
class CustomThemeState extends State<CustomTheme> {
  ...
  bool get isDart =>
      _themeKey == ThemeKeys.DARK || _themeKey == ThemeKeys.DARKER;
